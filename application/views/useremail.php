...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<img src="<?php echo base_url();?>/images/PepsiGraphic.gif" style="height:160px;width:170px;margin-left:75%;" alt="PepsiGraphic">
     ...
     <div class="col-sm-6"> <img src="<?php echo base_url();?>/images/Barcode.png" style="height:160px;" alt="Barcode">
	 </div>
  </div>	 
	<span>
	    <h5 style="margin-left:45%;height:1px;margin-top:10px;color:#7a1526; font-weight:550;"> GUEST BARCODES<h5>

		<hr style="width:450px; height:1px;margin-left:34%;background-color:#7a1526;">
  </span>
   <div class="row">
   <div class="col-sm-12">
